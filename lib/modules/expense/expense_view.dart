  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // কীবোর্ড ওপেন হলে যেন স্ক্রল করা যায়
          ...
          children: [
            ...
            Obx(() {
              ...
              return GridView.builder(
                shrinkWrap: true, // স্ক্রল ভিউ এর ভেতরে গ্রিডভিউ রাখার জন্য
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () => controller.savePresetExpense(amount),
                    child: Container(
                      decoration: BoxDecoration(
                        color: AppColors.surface,
                        borderRadius: BorderRadius.circular(15),
  ...
  void _showDeleteDialog(CategoryModel cat) {
    Get.defaultDialog(
      ...
      confirm: ElevatedButton(
        ...
        onPressed: () => Get.find<ExpenseController>().deleteCategory(cat.id),
        child: const Text(
          'Delete',
