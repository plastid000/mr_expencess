...
int _categoryModelEstimateSize(
  ...
  bytesCount += 3 + object.presets.length * 8;
  return bytesCount;
}
...
void _categoryModelSerialize(
  ...
  writer.writeLongList(offsets[1], object.presets);
}
...
CategoryModel _categoryModelDeserialize(
  ...
  object.presets = reader.readLongList(offsets[1]) ?? [];
  return object;
}
...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      presetsElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'presets',
        value: value,
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      presetsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByPresets() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'presets');
    });
  }
}
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, List<int>, QQueryOperations> presetsProperty() {
    return QueryBuilder.apply(this, (query) {
